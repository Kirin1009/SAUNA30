...
const KMIDS = QIDS.map(id => "km-" + id.slice(3));
/* 隠し絵14枚＋武将キャラ10枚＋家紋スタンプ14枚をプリキャッシュ（圏外対応。計約1.1MB） */
const ASSETS = ["./", "./index.html", "./manifest.json"].concat(QIDS.concat(CHIDS).concat(KMIDS).map(id => "./art/" + id + ".webp"));
